...
CREATE DATABASE PatoRestauranteDB;
...
(
    ...
    CONSTRAINT FK_SocialEvent_CreateUser		FOREIGN KEY (CreatedUser)	
		REFERENCES ApplicationUser(Id),
    CONSTRAINT FK_SocialEvent_ModifiedUser	FOREIGN KEY (ModifiedUser)	
		REFERENCES ApplicationUser(Id)
);
...
(
    ...
    CONSTRAINT FK_Reservation_Status FOREIGN KEY (StatusReservationId) 
		REFERENCES StatusReservation(Id)
);
